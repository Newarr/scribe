...
> Spec: `docs/spec/SPEC.md` · Open questions: archived (consolidated into SPEC.md) · Implementation roadmap: `docs/archive/superpowers/plans/2026-04-29-MASTER-ROADMAP.md`
