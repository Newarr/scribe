...
> **For agentic workers:** This is a roadmap, not an executable plan. Each slice listed here gets its own plan file in `docs/archive/superpowers/plans/` before implementation. Use `superpowers:subagent-driven-development` to execute each slice's plan task-by-task.

**Source spec:** `docs/spec/SPEC.md` (last updated 2026-04-29).
...
**Pending user validation per `docs/contributing/TESTING.md`** before tagging
