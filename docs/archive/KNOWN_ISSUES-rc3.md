...
With this list empty, the user can tag `v1.0.0` once `docs/contributing/TESTING.md` is walked through. Until then the build stays at `v1.0.0-rc3` (or `rc4` if a new audit finds more).
