...
This is the reference for any user-facing string in Transcriber. If you're touching a button label, a menu item, an alert, a transcript header, or any doc the user reads, this file is the contract.

The guide is opinionated. Disagreement should produce edits to the guide, not exceptions to it.

## Voice

Transcriber is a tool, not a personality. It speaks like a calm coworker who's been doing this job for years:
...
7. **Prefer "your" over "the".** "Your Transcriber folder" not "the output directory."
